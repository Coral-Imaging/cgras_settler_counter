...
# 6: 'recruit_dead', 7: 'recruit_cluster_dead', 9: 'pest_tubeworm'
...
model.train(data=data_file, epochs=1, batch=5, classes=[0,1,6,7,9])

print('Model Inference:')
image_file = '/home/java/Java/data/cgras_20230421/train/images/00_20230116_MIS1_RC_Aspat_T04_08.jpg'
results = model.detect(source=image_file)
print(results)
